    ...
    public partial class Billing : Form
    {
        ...
        private void btnCalc_Click_1(object sender, EventArgs e)
        {
            ...
            if (wrong == false)
            {
                ...
                string fileName = "lu_300234869";
                using (StreamWriter writer = new StreamWriter(fileName + ".txt"))
                {
                    writer.WriteLine("Name:        " + guest0name);
                    writer.WriteLine("Itinerary:   " + tripDetails);
                    writer.WriteLine("Ship:        "+ shipName);
                    writer.WriteLine("Depart:      " + departureDate);
                    writer.WriteLine("Cabin:       " + roomNumber + " (" + roomType + ") ");
                    writer.WriteLine("Deck Level:  " + deckName);
                    writer.WriteLine();
                    writer.WriteLine("Passenger:   " + totalTypeOfPass.Trim());
                    writer.WriteLine(totalGuestNames);
                    writer.WriteLine(displayPerPrice.Trim());
                    writer.WriteLine("Overall cost(tax included): $" + displayTotal);                 
                    ...
                    using (MySqlCommand command = new MySqlCommand())
                    {
                        ...
                        switch (numOfGuest)
                        {
                            ...
                            case 1:
                                ...
                                insertPassenger(conn, command, incrementPassengerId + 1, fNameGuest1Input.Text, lNameGuest1Input.Text, getLastPhoneId, getLastAddId, guest0email, dateToSqlGuest1);
                                command.CommandText = "";
                                break;
                            ...
                            case 2:
                                ...
                                insertPassenger(conn, command, incrementPassengerId + 1, fNameGuest1Input.Text, lNameGuest1Input.Text, getLastPhoneId, getLastAddId, guest0email, dateToSqlGuest1);
                                command.CommandText = "";
                                insertPassenger(conn, command, incrementPassengerId + 2, fNameGuest2Input.Text, lNameGuest2Input.Text, getLastPhoneId, getLastAddId, guest0email, dateToSqlGuest2);
                                command.CommandText = "";
                                break;
                            ...
                            case 3:
                                ...
                                insertPassenger(conn, command, incrementPassengerId + 2, fNameGuest2Input.Text, lNameGuest2Input.Text, getLastPhoneId, getLastAddId, guest0email, dateToSqlGuest2);
                                command.CommandText = "";
                                insertPassenger(conn, command, incrementPassengerId + 3, fNameGuest3Input.Text, lNameGuest3Input.Text, getLastPhoneId, getLastAddId, guest0email, dateToSqlGuest3);
                                command.CommandText = "";
                                break;
                        }
                        conn.Close();
